...
// configuration step. It creates a namespace called `Expanding_my_cpp`. You can modify
...
int main(int argc, const char **argv)
{
 ...
 Options:
    ...
    std::map<std::string, docopt::value> args = docopt::docopt(USAGE,
      ...
      fmt::format("{} {}",
        Expanding_my_cpp::cmake::project_name,
        Expanding_my_cpp::cmake::project_version));// version string, acquired
